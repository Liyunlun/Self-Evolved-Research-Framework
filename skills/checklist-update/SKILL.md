...
description: Mark affected checklist items done after work completes, add new [ ] items for newly discovered work, and annotate with timestamps and artifact paths. Triggers on "I finished X", "mark this done", "update the checklist", and chains from any skill that produces an artifact.
---
...
**Shared context**: Before running this skill, Read `skills/_shared/checklist-engine.md` for the marker vocabulary and deferred-propagation rule.
