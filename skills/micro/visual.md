# Visual Creation Micro-Skills

> Triggered by requests for visual content: pixel art, conceptual illustrations, architecture diagrams.
> These skills produce SVG/TikZ visual output distinct from data-driven figures (see writing.md § paper.figure).
...
**Inputs**: Visual description + style preferences
**Outputs**: SVG file in `outputs/visuals/`
**Token**: ~2-5K
**Composition**: `checklist.update` if part of a tracked deliverable
...
**Inputs**: Concept description + paper context
