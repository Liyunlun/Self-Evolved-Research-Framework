---
name: idea-verify
description: Check an idea's novelty by querying DBLP + arXiv + a cross-model subagent, then write a verdict (highly novel / somewhat novel / incremental / already exists) with closest existing work. Triggers on "is this idea novel?", "has this been done?", "check novelty", and follows idea-discover.
---
...
Key metrics for TD assessment: were novelty assessments accurate? did search find relevant prior work? cross-model agreement level?
