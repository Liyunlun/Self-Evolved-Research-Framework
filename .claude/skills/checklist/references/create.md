...
- "check paper", "paper audit" -> mid-term / paper-audit
- "explore whether X is feasible" -> short-term / idea
- "develop a new algorithm for Y" -> mid-term / method
- "paper writing" -> long-term / paper-writing
- "review loop" -> mid-term / review-loop
- "end-to-end", "full pipeline" -> long-term / research-pipeline
