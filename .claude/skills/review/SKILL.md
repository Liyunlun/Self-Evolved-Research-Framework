# /review — Cross-Model Dual Review

When to use this skill:
- When `config.yaml` section `dual_review.enabled` is true and a review-class skill fires
- During `writing.review`, `idea.verify`, `proof.critique`, or `experiment.analyze`
- User explicitly requests a second opinion or cross-model validation
- "Get another model's take on this", "dual review this"
